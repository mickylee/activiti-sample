...
import com.mickyli.workflow.po.Person;
...
public class TestProcessVariables {
	...
	/**
	 * 说明：输入流加载 资源文件的3种方式
	 *	  InputStream inputStreambpmn = this.getClass().getClassLoader().getResourceAsStream("processVariables.bpmn");
    ...
    public void startProcessInstance(){  
        ...
        ProcessInstance pi = processEngine.getRuntimeService()//与正在执行的流程实例和执行对象相关的Service  
                        .startProcessInstanceByKey(processDefinitionKey);//使用流程定义的key启动流程实例，key对应processVariables.bpmn文件中id的属性值，使用key值启动，默认是按照最新版本的流程定义启动  
    ...
    public void setVariables(){  
        ...
        //任务ID  
        String taskId = "22504"; //act_ru_task表里id  
        /**一：设置流程变量，使用基本数据类型*/  
